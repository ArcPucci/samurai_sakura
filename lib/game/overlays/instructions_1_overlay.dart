...
class Instructions1Overlay extends StatelessWidget {
  const Instructions1Overlay(this.game, {super.key});
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                "Catch petals by moving the\nwarrior with right/left arrows.",
                textAlign: TextAlign.center,
                style: AppTextStyles.medium16.copyWith(
                  color: Colors.black,
                ),
              ),
              BorderedButton(name: "Next", onTap: myGame.onNext),
            ],
          ),
        ),
      ),
